          ...
          <div className="form-group row">
            ...
            <div className="col-lg-10">
              ...
              >
                ...
                <option value="3"> AN BINH - NH TMCP AN BINH (ABBBANK) </option>
                <option value="4">
                  {' '}
                ...
                <option value="9"> BCB - BANK OF COMMUNICATIONS CN HCM </option>
                ...
                <option value="32"> FCB - FIRST COMMERCIAL BANK CN HCM </option>
                <option value="33"> FCB - FIRST COMMERCIAL BANK CN HN </option>
                <option value="34"> GPBANK - NH TMCP DAU KHI TOAN CAU </option>
                <option value="35">
                  {' '}
                ...
                <option value="45"> JPMB - JP MORGAN CHASE BANK CN HCM </option>
                <option value="46"> KBNN - KHO BAC NHA NUOC </option>
                <option value="47"> KEBHANA - KEB HANA BANK CN HA NOI </option>
                ...
                <option value="83"> TFB - TAIPEI FUBON COM.BANK CN HCM </option>
                <option value="84">
                  {' '}
                ...
                <option value="90"> VID - NH TNHH MTV PUBLIC VIET NAM </option>
              ...
              <small className="form-text text-muted">
                ...
                khoản tại ngân hàng gần nhất để nhận được khoản vay nhanh nhất.
              </small>
            </div>
          </div>
